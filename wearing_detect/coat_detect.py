...
class CoatDetector:
    ...
    def detect_frame(self, frame):
        ...
        # 检查是否检测到工作服
        coat_detected = any(detection.categories[0].category_name == "lab_coat" for detection in detection_result.detections)
        no_coat_detected = any(detection.categories[0].category_name == "no_coat" for detection in detection_result.detections)
        ...
        # 返回处理后的帧和检测信息
        detection_info = {
            'coat_detected': coat_detected,
            'no_coat_detected': no_coat_detected,
